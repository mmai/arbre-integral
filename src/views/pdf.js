...
export function renderPdf(editionId){
  ...
  if (editionId === "pending") {
    ...
    content = [
      ...
      h("div", [
        h('img', {attrs:{src:`${assetsDir}/cover19.png`, alt:"couverture"}}),
        h('img', {attrs:{src:`${assetsDir}/doublepage.png`, alt:"interieur"}})
      ]),
      ...
      h("div", "Étape 1 : Téléchargez le contenu édité et la couverture (illustrée par le tracé de votre parcours) de votre livre en cliquant sur les liens ci-dessous."),
      h("ul", [
      ...
      h("div", ["Étape 6 (couverture et quatrième de couverture) : Choisissez le modèle de couverture ", h('strong', "100% perso"), " et importez la ", h('strong', "couverture du livre"), ", sauvegardée sur votre terminal à l’étape 1.", h("br"), "Choisissez le ", h('strong', "noir"), " comme couleur pour la quatrième de couverture.", h("br"), "Il est Inutile de remplir les autres champs. "]),
