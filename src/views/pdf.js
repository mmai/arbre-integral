...
export function renderPdf(editionId){
  ...
  if (editionId === "pending") {
    ...
    content = [
      ...
      h("div", ["Étape 2 : Rendez-vous sur le site ", h("a", {attrs:{href: `http://www.blookup.com`}}, ["Blook", h("sup", "up")]), " et créez votre compte utilisateur."]),
      ...
      h("div", ["Étape 5 (format) : La maquette de l’Arbre Intégral correspond au format A6 ", h('strong', "(10X15 cm)"), " bientôt disponible sur Blook", h("sup", "up"), ". Il est possible, en attendant, d’utiliser le format 15x21 cm."]),
