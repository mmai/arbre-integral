...
export function renderShare (href, content) {
  ...
  return h('div.share', [
    ...
    h('div#share-panel', [
      h('a', {attrs: {title: 'Partager sur Facebook', href: 'https://www.facebook.com/sharer/sharer.php?u=http%3A//arbre-integral.net', target: '_blank' }}, [
      ...
      h('a', {attrs: {title: 'Partager sur Twitter', href: `https://twitter.com/home?status=${twitterContent}`, target: '_blank'}}, [
        h('svg', {attrs: {width: '24', height: '28', viewBox: '0 0 24 28'}}, [
